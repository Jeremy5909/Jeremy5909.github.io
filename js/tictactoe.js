$(document).ready(function() {
    ...
    $("#tictactoe #playButton").click(function (){
        ...
        player1Name = $("#tictactoe #player-1-inp").val();
        player2Name = $("#tictactoe #player-2-inp").val();
